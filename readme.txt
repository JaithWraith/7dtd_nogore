...
COMPATABILITY:
Since this mod relies on a customized entityclasses.xml file, it is not compatible with any mod that also modifies entityclasses. I'm new to making my mods available to others so if you have tips on how else I might approach the task of modding 7DTD in a more modular manner, I'm open to suggestions.
